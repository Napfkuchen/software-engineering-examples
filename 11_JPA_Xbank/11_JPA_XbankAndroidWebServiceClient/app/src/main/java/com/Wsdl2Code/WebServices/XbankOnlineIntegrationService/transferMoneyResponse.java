...
public class transferMoneyResponse implements KvmSerializable {
    
    public double newBalance;
    public boolean newBalanceSpecified;
    public String message;
    public int returnCodeField;
    
    public transferMoneyResponse(){}
    
    public transferMoneyResponse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("newBalance"))
        {
            ...
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                ...
                newBalance = Double.parseDouble(j.toString());
            }else if (obj!= null && obj instanceof Number){
                newBalance = (Double) obj;
            }
        }
        if (soapObject.hasProperty("newBalanceSpecified"))
        {
            Object obj = soapObject.getProperty("newBalanceSpecified");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                newBalanceSpecified = Boolean.parseBoolean(j.toString());
            }else if (obj!= null && obj instanceof Boolean){
                newBalanceSpecified = (Boolean) obj;
            }
        }
