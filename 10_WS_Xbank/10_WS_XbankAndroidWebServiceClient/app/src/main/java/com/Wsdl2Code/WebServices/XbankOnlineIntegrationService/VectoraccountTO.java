...
public class VectoraccountTO extends Vector<accountTO> implements KvmSerializable {
    
    
    public VectoraccountTO(){}
    
    public VectoraccountTO(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
